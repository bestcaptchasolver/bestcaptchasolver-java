...
public class Program {
    ...
    private static void test_api() throws Exception{
        ...
        while(image_text == null){          // while still in completion / solving process
            image_text = bcs.retrieve(id);    // try to get the
            Thread.sleep(2000);
        }
        ...
        while(gresponse == null){          // while still in completion / solving process
            gresponse = bcs.retrieve(id);    // try to get the
            Thread.sleep(2000);
        }
